(async () => {
    ...
    if (details && pid && !details.querySelector('button')) {
        details.insertAdjacentHTML('beforeend', `<button class="btn-shopping-cart btn-shopping-neutral use-ajax" data-progress-type="fullscreen" href="/en/direct-buy/add-to-cart/${pid}">Add to Cart | Ethereal</button>`)
    }
